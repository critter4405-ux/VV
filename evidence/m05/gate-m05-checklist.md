...
|---|---|---|---|
| 1 | `project.json`-Fragment M05 schema-valide, konsistent mit Migrationen | erfüllt | [validator-report.json](validator-report.json) (Schema 14/14, Abgleich 25/25) · [VV-M05.project.json](../../project/fragments/VV-M05.project.json) |
...
| 11 | Reparaturrunde 1 (R1–R8, G-1–G-3): je Fix gate-blockierende Gegenprobe, echte PG16 | erfüllt | [verification.md](verification.md) §Reparaturrunde 1 · M05 133/133, Stage-0 33/33 in [db-asserts.txt](db-asserts.txt) |

**Offen (nicht Bau-KI):** formales Vier-Augen-Review über den reparierten Stand (Codex-Modell entscheidet der Betreiber nach Kalibrierung) + Gemini · Betreiber-Freigabe M05-Gate (Phase D). GitHub-Ruleset (R6) bei Remote-Anlage.
