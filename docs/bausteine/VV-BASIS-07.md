# Bau-Dossier — VV-BASIS-07 · Finanz-Grundlagen
...
*(zu füllen beim Bau)* Ziel dieses Bausteins: Datengrundlage Person ↔ Beitrag ↔ Zahlung; SEPA-Mandat modelliert, nicht ausgeführt.
...
```mermaid
flowchart LR
    P["Problem"] --> L["VV-BASIS-07<br/>Lösung"]
    L --> N["Nutzen"]
```

## 8. Nutzen in Klartext

Beiträge und offene Posten im Blick — Geld bewegt sich nie ohne Freigabe.
