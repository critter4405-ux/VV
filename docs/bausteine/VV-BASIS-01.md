# Bau-Dossier — VV-BASIS-01 · Personen- & Mitgliederregister
...
- **Code:** VV-BASIS-01
- **Name:** Personen- & Mitgliederregister
...
*(zu füllen beim Bau)* Ziel dieses Bausteins: Ein zentrales, eindeutiges Register aller natürlichen Personen als Single Source of Truth.
...
```mermaid
flowchart LR
    P["Problem"] --> L["VV-BASIS-01<br/>Lösung"]
    L --> N["Nutzen"]
```

## 8. Nutzen in Klartext

Jede Person nur einmal — saubere Stammdaten für alle Module und Agenten.
