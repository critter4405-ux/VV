...
- **Status/Gate:** gebaut · R1 **nicht bestanden** → WP0–WP7 · R2 (Codex „nicht bestanden"/Gemini „bestanden mit Auflagen") → F1–F8 · R3 (Codex „nicht bestanden": CRITICAL Metadaten-Spoofing + 4 HOCH; Gemini „bestanden mit Auflagen") → **Reparaturrunde 3 (G1–G9) umgesetzt & gegen echte PostgreSQL 16 + adversarial verifiziert** (18.09.2026) · **Gate 0→1: 4. Fremdmodell-Review ausstehend** (siehe `REVIEW-Befunde-Stage-0.md`, `evidence/stage-0/round3-verification.md`)
