...
#   vv_m05_pg   postgres:16      — Datenbank (Migrationen 0001–0012 + synthetische Seeds)
...
hd "1) Frische PostgreSQL 16 + Migrationen 0001–0012 + Seeds"
...
[ "$RE" = "OK" ] && ok "0006–0012 erneut fehlerfrei (idempotent)" || no "Idempotenz: $RE"
